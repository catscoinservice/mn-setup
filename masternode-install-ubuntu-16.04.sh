...
COIN_TGZP='https://github.com/catscoinservice/wallets/releases/download/2004/cats2004-linux.zip'
COIN_BOOTSTRAP='https://github.com/catscoinservice/wallets/releases/download/2004/bootstrap.zip'
