...
COIN_TGZP='https://github.com/catscoinservice/wallets/releases/download/2005/cats-linux2005.zip'
COIN_BOOTSTRAP='https://github.com/catscoinservice/wallets/releases/download/2005/bootstrap.zip'
